...
namespace ADTechnology.AbInitio.Classes
{
  internal class PhaseRevision
  {
    ...
    public Vertex AddOrModifyVertex(string line)
    {
      ...
      string vertexName = line.Substring(startIndex + 13);
      ...
      vertex.CPU = Convert.ToDouble(line.Substring(startIndex - 13, 12));
      vertex.Skew = Convert.ToDouble(line.Substring(startIndex + 7, 4));
      vertex.Status.Parse(line.Substring(startIndex, 7));
